...
| Q-ZOMBIE | `processed/quaternius/animations/enemy_attacks.glb` | 77,428 | `e7efa1a952b1cac8a5b64b4eca5c40432256dffdc8b597afd4dd91654defdc90` | P32 Blender 5.2.0 animation-only carrier derived from the receipted `zombie_basic.glb`; exact `Idle_Attack` action and ordered 50-joint hierarchy retained; preview meshes, materials, and images removed. |
