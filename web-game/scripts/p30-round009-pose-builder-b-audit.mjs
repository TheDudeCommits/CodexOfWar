...
const WIDTH = 1600;
const HEIGHT = 900;
const BASE_COMMIT = "afc1063812473087a645271e2c33adcd0534225a";
const REPO_ROOT = resolve(process.cwd(), "..");
const OUTPUT_ROOT = resolve(
  process.env.ROUND009_POSE_OUTPUT_ROOT ?? "../ArtSource/P30/Round009/BuilderB",
);
const BASE_URL =
  process.env.ROUND009_POSE_URL ??
  "http://127.0.0.1:4173/?review=1&post=0&framing=1";
const CHROME = "/Applications/Google Chrome.app/Contents/MacOS/Google Chrome";
const STABILITY_MS = Number(process.env.ROUND009_POSE_STABILITY_MS ?? 30_000);
...
const poseContract =
  ...
  s04.pose.contact.bladeToTargetMeters <= 0.3 &&
...
const poseTelemetry = {
  schema: "p30.round009.builder-b.pose-telemetry.v1",
...
const runtimeTelemetry = {
  schema: "p30.round009.builder-b.runtime-telemetry.v1",
  baseCommit: BASE_COMMIT,
  candidateOnly: true,
  acceptanceClaimed: false,
...
const receipt = {
  schema: "p30.round009.builder-b.capture-receipt.v1",
  baseCommit: BASE_COMMIT,
  branch: "codex/p30-r009-pose-builder-b",
  candidateOnly: true,
  acceptanceClaimed: false,
  headed: true,
  viewport: { width: WIDTH, height: HEIGHT, dpr: 1 },
  captures: allCaptures,
  runtimeTelemetryFile: "ArtSource/P30/Round009/BuilderB/runtime-telemetry.json",
  poseTelemetryFile: "ArtSource/P30/Round009/BuilderB/pose-telemetry.json",
  gates: {
