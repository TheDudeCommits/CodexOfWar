...
| 3 | Zombie | [Zombie 3D by @chuvit](https://sketchfab.com/3d-models/zombie-3d-31ca8d86b4074312a51170d8e7dbe07c) | 22.1K tris / 11.6K vertices; fully rigged; PBR diffuse, normal, roughness, and metallic maps at 2K/4K; page lists OBJ, FBX, and GLB. | CC Attribution on the asset page. Credit the creator and Sketchfab, link the asset and [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/), and state modifications. CC BY permits commercial adaptation but does not remove possible publicity, privacy, or moral-right issues. | The skeleton hierarchy, bind pose, animation clips, material count, and actual download contents are not published. Do not batch-retarget until a one-clip deformation test passes shoulders, jaw, wrists, and pelvis. The 4K maps must not ship uncompressed. |
...
The selected zombie is the best **documented web-budget compromise**: authored topology, a stated rig, a complete PBR channel set, and a direct GLB path at 22.1K tris. A visually denser fallback is [Zombie “Egor” by David Glynch](https://sketchfab.com/3d-models/zombie-6ff73b06cf63405d9557720c78cf5e0c): 109.4K tris / 54.7K vertices, PBR, listed as rigged, under Free Standard. The [Fab Standard License](https://www.fab.com/eula?lang=en) permits commercial projects, modification, use outside Unreal, and requires no attribution, but forbids standalone redistribution. Egor needs aggressive LOD/texture validation and its page does not publish map resolution or animation clips, so it is an art-spike alternative, not the first integration.
...
- `Zombie 3D` by `@chuvit`, via Sketchfab, CC BY 4.0; include asset URL, license URL, and “modified/optimized for Codex of War.”
...
This shortlist clears commercial-use and practical-format gates based on published evidence. It does **not** clear final art direction, deformation, animation quality, performance, or blind-reference acceptance until the actual downloads pass the intake gate above.
